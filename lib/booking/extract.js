...
async function chamarGroq(messages) {
  // gpt-oss-120b tem so 8.000 tokens/min no tier "on_demand" gratuito da Groq - qualquer
  // documento real (schema + prompt + texto) passa disso e devolve 413. gpt-oss-20b tem
  // limite bem maior nesse mesmo tier e ja e usado em producao (app.js/chat.js/gerar-escala.js)
  // sem esse problema.
