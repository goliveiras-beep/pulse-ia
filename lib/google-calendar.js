  ...
  for (let i = 0; i < totalDias; i++) {
    ...
    try {
      ...
      await upsertEvento(accessToken, eventId, {
        ...
        transparency: 'transparent',
        // Flamingo — o vermelho-coral mais próximo do #e53e3e da marca Pulse dentro da paleta
        // fixa do Calendar, mantendo distinto do Tomato (11) já usado em Folga/Ausência/prazo Alta.
        colorId: '4',
      });
