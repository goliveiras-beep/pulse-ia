...
export default async function handler(req, res) {
  ...
  function cardAtivo(m) {
    ...
    const badgeRestricao = nRestricoes ? `<span style="background:#fef3c7;color:#92400e;border-radius:4px;padding:2px 7px;font-size:10px;font-weight:600">🕐 ${nRestricoes} restrição${nRestricoes>1?'ões':''}</span>` : '';
    return `
