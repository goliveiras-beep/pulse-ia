...
const JORNADA_SEMANAL_CLT_PJ = 40;
...
function topUpSemanal40h(diaCalcs) {
...
function calcularDia(durBruta, tipo, semBanco) {
...
// as horas BRUTAS no período noturno — quem chama aplica o fator de 20% (ver uso abaixo).
