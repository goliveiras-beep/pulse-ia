...
export default async function handler(req,res){
  ...
  if(colaboradores.length===0){
    ...
    // Início usa o ano mais próximo de hoje (mesma lógica de dfParaDateProxima), não o ano
    // corrente fixo — senão uma folga marcada pra janeiro do ano que vem cai fora do lugar no
    // gráfico. E se a ausência vira o ano (ex: início 28/12, fim 05/01), o fim tem que valer
    // pro ano seguinte ao do início — senão a data de fim cai "antes" e a barra fica errada.
