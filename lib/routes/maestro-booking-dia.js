  ...
  return `
    <div class="grade-dia-cols" style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
      <div>
        ...
        <div id="colProximos">${resto.map(htmlDe).join('')}</div>
        <div id="colProximosEmpty" class="empty" style="display:${resto.length ? 'none' : 'block'}">Nenhum evento</div>
      </div>
      <div>
    ...
    <script>
      ...
      function reordenarEventosBooking() {
        ...
        todos.forEach(function (c) {
          if (c.classList.contains('g-ev-encerrado')) { c.style.display = 'none'; return; } // ja passou - some das duas colunas
          c.style.display = '';
