...
<div style="text-align:right;margin-bottom:8px">
  <a class="btn-sm" href="/api/maestro-booking" style="display:inline-block">📄 Booking — extração de parâmetros</a>
  <a class="btn-sm" href="/api/maestro-booking-dia" style="display:inline-block">🗓️ Booking — grade do dia</a>
</div>
<div class="card">
